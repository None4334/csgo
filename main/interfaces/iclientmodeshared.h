...
public:
	...
	int			nMotionBlurMode;
	float		flShutterTime;
	Vector3D		vecShutterOpenPosition;
	Vector3D		vecShutterOpenAngles;
	Vector3D		vecShutterClosePosition;
	Vector3D		vecShutterCloseAngles;
